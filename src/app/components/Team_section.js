...
const Team_section = ({ title, content, bg_image,classes }) => {
  ...
  return (
    <section className={`bg-[#FFFBF2] ${classes}`}>
      ...
      <div className="flex flex-col items-center">
        <div
          className="w-full relative text-white bg-cover"
                    ...
                    <div className="flex flex-col justify-end gap-4 3xl:gap-8 p-4 3xl:px-7 3xl:py-12 min-h-96 lg:min-h-[500px] 3xl:min-h-[700px] card hover:pb-16 3xl:hover:pb-44 transition-all duration-300">
                      <div className="flex gap-2 3xl:gap-5 relative z-10">
                        ...
                        <span className="font-semibold text-xl 3xl:text-[28px] 3xl:leading-[36px]">
                          {val.vorteile_content_title}
                        </span>
                      </div>
                      <div
                        className="font-medium relative z-10 space-y-4 *:text-base *:3xl:text-lg"
                        dangerouslySetInnerHTML={{
                          __html: val.vorteile_content_description,
                        }}
                      ></div>
                    </div>
                  </SwiperSlide>
              ...
              {/* <SwiperSlide>
                ...
                <SwiperSlide>
                  <div className="flex flex-col justify-end gap-4 3xl:gap-8 p-4 3xl:px-7 3xl:py-12 min-h-96 lg:min-h-[500px] 3xl:min-h-[700px] card hover:pb-16 3xl:hover:pb-44 transition-all duration-300">
                    ...
                    <div className="font-medium relative z-10 space-y-4 *:text-base *:3xl:text-lg">
                      <p>
                        Jede Behandlung ist auf Ihre persönliche Situation und
                ...
                <SwiperSlide>
                  <div className="flex flex-col justify-end gap-4 3xl:gap-8 p-4 3xl:px-7 3xl:py-12 min-h-96 lg:min-h-[500px] 3xl:min-h-[700px] card hover:pb-16 3xl:hover:pb-44 transition-all duration-300">
                    ...
                    <div className="font-medium relative z-10 space-y-4 *:text-base *:3xl:text-lg">
                      <p>
                        Wir vergeben Termine so, dass Sie schnell die
                ...
                <SwiperSlide>
                  <div className="flex flex-col justify-end gap-4 3xl:gap-8 p-4 3xl:px-7 3xl:py-12 min-h-96 lg:min-h-[500px] 3xl:min-h-[700px] card hover:pb-16 3xl:hover:pb-44 transition-all duration-300">
                    ...
                    <div className="font-medium relative z-10 space-y-4 *:text-base *:3xl:text-lg">
                      <p>
                        Jahrelange Erfahrung und kontinuierliche Weiterbildungen
                        sorgen für zielgerichtete Hilfe.
                      </p>
                    </div>
                  </div>
                </SwiperSlide> */}
